...
pathlib.Path("D:/projects/Dhan_Saarthi/Saarthi/frontend/app/domain/recommendations.tsx").write_text(code, encoding="utf-8")
print("Successfully generated recommendations.tsx")
