                ...
                {recommendations.map((rec) => (
                  <View key={rec.scheme.scheme_id} style={styles.recCard}>
                    <View style={styles.cardHeaderRow}>
                      ...
                      <View style={[styles.rankBadge, styles[`rank_${rec.relevance_rank}` as keyof typeof styles]]}>
...
pathlib.Path("D:/projects/Dhan_Saarthi/Saarthi/frontend/app/domain/schemes.tsx").write_text(code, encoding="utf-8")
print("Successfully generated clean schemes.tsx")
